...
- [ ] Valerie Kaur's page shows the $25,000 gift, the THANK recommendation with its evidence, and email as the allowed channel.
- [ ] Once slices 002 and 003 are merged, Kieran Kaur's page shows WAIT with its count, Nia Chen's shows FOLLOW UP, and Isaac Chen's shows "No action recommended" plus his kept May 15 commitment.
- [ ] The assigned fundraiser is shown before the recommendation (G3).
- [ ] Missing fields show "Not on file" (G4).
- [ ] Unknown, non-individual, or deceased ids return a clear not-found state.
- [ ] The layout reads as a narrative (header, why, context), not a scorecard, and shows no numeric relationship score.
- [ ] Every "View relationship" link on Today opens the right person.
